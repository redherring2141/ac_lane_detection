...
def process_frame(self, img_org, flag=False):
    ...
    img_wlane_th = luv_select(img_pers, ch='l', thresh=(225,255))
    img_roi_wlane = mask_roi(img_wlane_th)

    img_ylane_th = lab_select(img_pers, ch='b', thresh=(150,200))
    ...
    img_combined[(img_roi_abx==1) | (img_roi_ylane==1) | (img_roi_mag==1) | (img_roi_wlane==1)]=1
    ...
    img_fin = draw_lane(img_combined, l_avg_fitx, r_avg_fitx, ploty_img, img_undist, Minvs)

    cv2.putText(img_fin, ("Curve Radius: " + str(avg_curve_r) + "m"), (256, 50), font, 1, (255, 255, 255), 2, cv2.LINE_AA)
    cv2.putText(img_fin, ("Center Offset: " + str(offset_m) + "m"), (256, 100), font, 1, (255, 255, 255), 2, cv2.LINE_AA)
    cv2.putText(img_fin, ("Distance b/w Lines: " + str(dist_bw_lines)), (256, 150), font, 1, (255, 255, 255), 2, cv2.LINE_AA)
    cv2.putText(img_fin, ("Distance Square Err: " + str(dist_diff_squa)), (256, 200), font, 1, (255, 255, 255), 2, cv2.LINE_AA)
    cv2.putText(img_fin, ("Distance MSE: " + str(dist_mse)), (256, 250), font, 1, (255, 255, 255), 2, cv2.LINE_AA)
